...
import { iconBackStyles } from "./icon-back.styles";

// from Streamline Icons - https://www.streamlinehq.com/icons/pixel?search=back&icon=ico_HZrYl1TjosKrh6jv
@customElement("ur-icon-back")
export class IconBack extends LitElement {
	static styles = iconBackStyles;
