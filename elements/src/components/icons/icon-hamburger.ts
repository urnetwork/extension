...
import { iconHamburgerStyles } from "./icon-hamburger.styles";

// from Streamline Icons - https://www.streamlinehq.com/icons/pixel?search=menu&icon=ico_RnaQZYcUsKZvggE9
@customElement("ur-icon-hamburger")
export class IconHamburger extends LitElement {
	static styles = [iconBaseStyles, iconHamburgerStyles];
