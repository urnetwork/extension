...
import { iconConnectGlobeStyles } from "./icon-connect-globe.styles";

@customElement("ur-icon-connect-globe")
export class IconConnectGlobe extends LitElement {
	static styles = [iconBaseStyles, iconConnectGlobeStyles];
