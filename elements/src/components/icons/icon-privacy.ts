...
import { iconPrivacyStyles } from "./icon-privacy.styles";

// from Streamline Icons - https://www.streamlinehq.com/icons/pixel?search=privacy&icon=ico_VIG2k3sqsNrZSfiM
@customElement("ur-icon-privacy")
export class IconPrivacy extends LitElement {
	static styles = [iconBaseStyles, iconPrivacyStyles];
