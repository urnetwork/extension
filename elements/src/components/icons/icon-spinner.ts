...
import { iconLoadingStyles } from "./icon-spinner.styles";

// from Streamline Icons -  https://www.streamlinehq.com/icons/pixel?search=loading&icon=ico_pY3gJQzm3vSdbbtl
@customElement("ur-icon-spinner")
export class IconSpinner extends LitElement {
	static styles = [iconBaseStyles, iconLoadingStyles];
